...
#if P_SILVALLY_TYPE_CHANGE_Z_CRYSTAL == TRUE
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_FIGHTING, ITEM_FIGHTINIUM_Z,    ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_FLYING,   ITEM_FLYINIUM_Z,      ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_POISON,   ITEM_POISONIUM_Z,     ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_GROUND,   ITEM_GROUNDIUM_Z,     ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_ROCK,     ITEM_ROCKIUM_Z,       ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_BUG,      ITEM_BUGINIUM_Z,      ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_GHOST,    ITEM_GHOSTIUM_Z,      ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_STEEL,    ITEM_STEELIUM_Z,      ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_FIRE,     ITEM_FIRIUM_Z,        ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_WATER,    ITEM_WATERIUM_Z,      ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_GRASS,    ITEM_GRASSIUM_Z,      ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_ELECTRIC, ITEM_ELECTRIUM_Z,     ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_PSYCHIC,  ITEM_PSYCHIUM_Z,      ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_ICE,      ITEM_ICIUM_Z,         ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_DRAGON,   ITEM_DRAGONIUM_Z,     ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_DARK,     ITEM_DARKINIUM_Z,     ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_FAIRY,    ITEM_FAIRIUM_Z,       ABILITY_RKS_SYSTEM},
#endif
    {FORM_CHANGE_TERMINATOR},
};
